EXPLICACIÓN:
Este programa de Python genera un árbol sintáctico que se forma de una cadena en base a reglas gramaticales que se le propicien y la cadena que se ingrese, en el dado caso de que esta cumpla las reglas, de lo contrario mostrara que no es valida.
Las reglas gramaticales están definidas por medio de un archivo de texto llamado "gramatica.txt", este contiene lo siguiente
E->T E'
E'->opsuma T E'
E'->ε
T->F T'
